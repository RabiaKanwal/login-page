          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-center space-x-4">
                ...
                <span className="text-sm text-text-muted px-4">Or Continue with</span>
                <div className="h-px bg-gray-300 flex-1"></div>
              </div>
              ...
              <div className="flex justify-center space-x-4">
                ...
                <button className="w-16 h-16 rounded-2xl border border-neutral-border bg-white shadow-design flex items-center justify-center hover:bg-gray-50">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                    ...
                    <path fillRule="evenodd" clipRule="evenodd" d="M12 5.07386C13.6883 5.07386 15.2043 5.65409 16.3961 6.79364L19.6945 3.49523C17.7029 1.63955 15.0997 0.5 12 0.5C7.50451 0.5 3.61539 3.07705 1.72302 6.83545L5.56519 9.815C6.46951 7.09682 9.00474 5.07386 12 5.07386Z" fill="#EA4335"/>
                  </svg>
                </button>
